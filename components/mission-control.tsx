      ...
      <Card className="mb-4">
        <CardContent className="pt-4 pb-3">
          ...
          <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-0.5 pt-1">
                  ...
                  <p className="text-[10px] text-muted-foreground tabular-nums">
                    ...
                    {scoreboard.calls > 0 && (
                      <span className="font-medium text-foreground ml-1">
                        ({Math.round((scoreboard.actionCount / scoreboard.calls) * 100)}%)
                      </span>
                    )}
                  </p>
                )}
                {scoreboard.winCount !== null && (
                  <p className="text-[10px] text-muted-foreground tabular-nums">
                    ...
                    {scoreboard.calls > 0 && (
                      <span className="font-medium text-foreground ml-1">
                        ({Math.round((scoreboard.winCount / scoreboard.calls) * 100)}%)
                      </span>
                    )}
                  </p>
                )}
            ...
            <div className={`rounded-lg border p-3 ${overdueCount === 0 ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"
              }`}>
              <div className="flex items-center gap-1.5 mb-1">
                {overdueCount === 0
