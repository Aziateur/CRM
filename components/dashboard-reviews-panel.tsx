...
import { Loader2, BarChart3, Tag, Zap, TrendingUp, Calendar } from "lucide-react"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <Card>
                    <CardContent className="pt-4">
                        ...
                        <p className="text-2xl font-bold mt-1">{stats.quick} / {stats.deep}</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent className="pt-4">
                                ...
                                {Object.entries(stats.decisionCounts)
                                    ...
                                    .map(([type, count]) => (
                                        <div key={type} className="flex items-center justify-between">
                                            <span className="text-sm font-medium">{DECISION_LABELS[type] || type}</span>
