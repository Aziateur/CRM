                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <Input value={ed.nextCallObjective || ""} onChange={(e) => setEditedLead({ ...ed, nextCallObjective: e.target.value })} onBlur={() => autoSave("next_call_objective", ed.nextCallObjective)} placeholder="Confirm whether fuel contracts renew quarterly or annually." />
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    {fieldDefinitions
                      .filter((f) => f.section === "core" && !f.isMasked)
                      .map((field) => {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    {fieldDefinitions
                      .filter((f) => f.section === "detail" && !f.isMasked)
                      .map((field) => {
                        const fieldValue = (field.source === "native" || field.isPromoted)
                          ? (ed as unknown as Record<string, unknown>)[field.fieldKey] ?? null
                          : ed.customFields?.[field.fieldKey] ?? null
